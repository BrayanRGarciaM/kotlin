...
import e.bolsadeideas.fanatic.core.BaseViewHolder
import e.bolsadeideas.fanatic.data.model.Movie
import e.bolsadeideas.fanatic.databinding.ProductItemBinding
...
class ProductAdapter(
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<*>, position: Int) {
        when(holder){
            is ProductViewHolder -> holder.bind(moviesList[position])
        }
    }
